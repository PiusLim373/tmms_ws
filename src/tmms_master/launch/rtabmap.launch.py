...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('gui_cfg',  default_value='~/.htxgrrt/maps/rtabmap_gui.ini',  description='Configuration path of rtabmap_viz.'),
        ...
        DeclareLaunchArgument('database_path',  default_value='~/.htxgrrt/maps/default_map.db',  description='Where is the map saved/loaded.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/dog_imu_raw', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
